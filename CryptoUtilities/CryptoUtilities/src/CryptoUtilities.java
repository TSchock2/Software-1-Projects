...
public final class CryptoUtilities {
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        NaturalNumber value = new NaturalNumber2(n);
        NaturalNumber two = new NaturalNumber2(2);
        NaturalNumber remainder = value.divide(two);
        if (remainder.isZero()) {
            status = true;
        } else {
            status = false;
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
         ...
         */
        NaturalNumber pow = p.newInstance();
        pow.copyFrom(p);
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber witness1 = w.newInstance();
        witness1.copyFrom(w);
        NaturalNumber witness2 = w.newInstance();
        witness2.copyFrom(w);
        ...
        powerMod(witness1, two, n);
        NaturalNumber r1 = witness1.divide(n);
        powerMod(witness2, num, n);
        NaturalNumber r2 = witness2.divide(n);
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        NaturalNumber rnd = n.newInstance();
        rnd.copyFrom(n);
