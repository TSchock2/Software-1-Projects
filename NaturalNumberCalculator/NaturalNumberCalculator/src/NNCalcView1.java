...
public final class NNCalcView1 extends JFrame implements NNCalcView {
     ...
     */
    /*
     * Added 10 for number of digits on calculator to establish bDigits
     *
     */
    ...
    public NNCalcView1() {
        ...
        //Number of buttons pressed placed into array
        ...
        JScrollPane botScrollPane = new JScrollPane(this.tBottom);
    ...
    public void updateTopDisplay(NaturalNumber n) {
        ...
        String topText = n.toString();
        this.tTop.setText(topText);
    ...
    public void updateBottomDisplay(NaturalNumber n) {
        ...
        String botText = n.toString();
        this.tBottom.setText(botText);
